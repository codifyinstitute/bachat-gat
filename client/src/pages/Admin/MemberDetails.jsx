  ...
  return (
    <div className="w-full p-0 bg-gradient-to-r from-blue-50 to-purple-100 min-h-screen mt-10 md:mt-4 lg:mt-2">
      <div className="w-full bg-white shadow-lg rounded-lg px-4 py-5 mx-auto">
                  ...
                  <td className="py-3 px-4 flex justify-between items-center">
                    {item.label === "ID" ? (
                      <>
                        ...
                        <span className="md:hidden">{member._id.substring(0, 10) + '...'}</span>
        ...
        <div className="bg-gradient-to-r from-green-100 to-green-50 mt-6 p-6 rounded-xl shadow-lg border-2 border-green-300">
          <h2 className="text-lg font-semibold text-gray-700 mb-4">
            Created By
          </h2>
          <table className="min-w-full table-auto">
            <tbody className="divide-y divide-gray-200">
              ...
              {[
                {
                  label: "Crp Name",
                  value: (member.referredBy?.crpName),
                },
                {
                  label: "Crp Id",
                  value: (
                    <span className="block">
                      <span className="md:hidden">
                        {member.referredBy?.crpId.slice(0, 10)}...
                      </span>
                      <span className="hidden md:inline">
                        {member.referredBy?.crpId}
                      </span>
                    </span>
                  ),
                },                
                {
                  label: "Crp Mobile",
                  value: (member.referredBy?.crpMobile
                    ),
                },
              ].map((item) => (
                <tr key={item.label}>
